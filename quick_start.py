...
tasks = {
    ...
    'Minigrid': ['python polrank --env_name MiniGrid-SimpleCrossingS9N1-v0 --pol_name minigrid_good --pol_d_name {} --cond_name score0.8 -nr 5000 -nt 100 -ni 200 -mu 0.2',
                 'python polrank/__main__2.py --env_name MiniGrid-SimpleCrossingS9N1-v0 --pol_name minigrid_good --pol_d_name {} --cond_name score0.8 -nr 5000 -nt 100 -ni 200 -mu 0.2'],
    # CartPole
    'CartPole': ['python polrank --env_name CartPole-v0 --pol_name CartPole_good --pol_d_name {} --cond_name score200 -nr 5000 -nt 100 -ni 100 -mu 0.4',
                 'python polrank/__main__2.py --env_name CartPole-v0 --pol_name CartPole_good --pol_d_name {} --cond_name score200 -nr 5000 -nt 100 -ni 100 -mu 0.4'],
    # Atari Games
    'Atari':  ['python polrank --env_name UBER{} --pol_name UBER{} --pol_d_name {} --cond_name score_auto -nr 1000 -nt 50 -ni -1 -mu 0.2 -a -1 --max_steps 600',
               'python polrank/__main__2.py --env_name UBER{} --pol_name UBER{} --pol_d_name {} --cond_name score_auto -nr 1000 -nt 50 -ni -1 -mu 0.2 -a -1 --max_steps 600']
}

if env in atari_games_clean:
    commands = [command.format(env, env, pol_d) for command in tasks['Atari']]
else:
    commands = [command.format(pol_d) for command in tasks[env]]
